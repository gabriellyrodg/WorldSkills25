...
class Program
{
    static void Main()
    {
        try
        {
            ...
            Console.WriteLine("Arquivo 'planilha.xlsx' criado com sucesso! Pressione Enter para continuar.");
            Console.Clear();
            Console.WriteLine("Conteúdo da planilha:\n ");
            Console.WriteLine($"Nomes: {string.Join(", ", nomes)}\n ");
            Console.WriteLine($"Idades: {string.Join(", ", idades)}\n ");
